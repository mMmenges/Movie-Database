...
/**
 * @requires React
 * @requires react-bootstap/Form
 * @requires react-bootstap/Button
 * @requires react-bootstap/Col
...
/**
 * exporting the login view function to allow users to navigate to the login screen
 * @function LoginView
 * @param {*} props
 */
